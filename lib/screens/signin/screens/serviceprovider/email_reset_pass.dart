...
import 'package:mtgy_app/screens/signin/screens/serviceprovider/code_verif.dart';
...
class SPEmailResetPassword  extends StatelessWidget {
   SPEmailResetPassword ({Key? key}) : super(key: key);
      ...
      body: BlocProvider(
        ...
        child: BlocConsumer<MTGYAppSignInCubit,MTGYSignInAppStates>(
          builder: (BuildContext context, state) {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ConditionalBuilder(
                          condition: state is! SPForgetPassLoadingState ,
                          builder: (BuildContext context) {
                            return  ElevatedButton(
                              onPressed: () {
                                if (_formKey.currentState!.validate()) {
                                  MTGYAppSignInCubit.get(context).SPforgetPassword(
            ...
            if(state is SPForgetPassSuccessState)
              {
                Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder:
                    (context)=>SPVerifycode()), (route) => false);
              }
        },
        ),
      ),
