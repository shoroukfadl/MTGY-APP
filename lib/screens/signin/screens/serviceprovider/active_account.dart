...
class SPActivateAccount extends StatelessWidget {
   SPActivateAccount({super.key});
    ...
    return BlocProvider(create: (BuildContext context) => MTGYAppSignInCubit(),
      child: BlocConsumer<MTGYAppSignInCubit,MTGYSignInAppStates>(
                    ...
                    return  ElevatedButton(
                      onPressed: () {
                        if (_formkey.currentState!.validate()) {
                          MTGYAppSignInCubit.get(context).SPActivateAccount(
        ...
        listener: (context,state){
          if(state is SPActivateSuccessState){
