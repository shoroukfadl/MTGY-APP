...
import '../settings/edit_profile_client.dart';
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child:  Row(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.center,
                                            children: [
                                              Text("Chats",style: GoogleFonts.lobster(color:WhiteColor,fontSize: 18),),
                                              IconButton(
                                                onPressed:(){
                                                  Navigator.push(
                                                    context,
                                                ...
                                                icon : const Icon(Icons.mark_chat_unread,size: 20,),
                                                color: YellowColor,),
                                            ],
                                          ),
                                        ),
                                        ...
                                        Container(
                                          ...
                                          child:  Row(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.center,
                                            children: [
                                              Text("Cart",style: GoogleFonts.lobster(color:WhiteColor,fontSize: 18),),
                                              IconButton(
                                                onPressed:(){
                                                  Navigator.push(
                                                    context,
