      ...
      child: BlocConsumer<SPHomeCubit,SPHomeStates>(
       builder: (context,state){
             ...
             child: Container(
               ...
               child: ListView(
                 children: [
                   ...
                   buildDeleteAccount(context ,"Our WebSite"),
        ...
        listener: (context,state){
         ...
         if(state is SPSignoutSuccessState)
         {
           Fluttertoast.showToast(
               msg: "Account Sign Out Successfully ",
               toastLength: Toast.LENGTH_LONG,
               gravity: ToastGravity.SNACKBAR,
               timeInSecForIosWeb: 3,
               backgroundColor: YellowColor,
             ...
             Navigator.of(context).pushAndRemoveUntil(
                 MaterialPageRoute(builder: (context)=> ServiceProviderSignIn()),
                     (route) => false)
           });
         }
       },
