...
class Resorts_Villages extends StatelessWidget {
  @override
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      UHomeCubit()
        ..GetResortAndVillageData(),
      child: BlocConsumer<UHomeCubit, UHomeStates>(
        builder: (BuildContext context, state) {
          return ConditionalBuilder(
            condition: resort_list.isNotEmpty ,
                                    ...
                                    InkWell(
                                      onTap: () =>
                                          UHomeCubit.get(context)
                                              ...
                                              id: resort_list[index].spid!)
                                      ,
                                      child: Text(
                                        resort_list[index].serviceName!,
                                            ...
                                            child: Container(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () =>
                                                    UHomeCubit.get(context)
                                                        .UaddtoCart(
                                                        service: resort_list[index]
                                                            .serviceName!,
                                                        amount: int.parse(
                                                            countercontroller
                                                                .text),
                                                        price: resort_list[index]
                                                            .price!,
                                                        id: resort_list[index]
                                                            .id!,
                                                        image: resort_list[index]
                                                            .image!,
                                                        category: resort_list[index]
                                                            .category!),
                                                style: ElevatedButton.styleFrom(
                                                  fixedSize: const Size(
                                                      350, 45),
