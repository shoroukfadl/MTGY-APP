...
class Hotels extends StatelessWidget   {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) =>UHomeCubit()..GetHotelData(),
      child: BlocConsumer<UHomeCubit,UHomeStates>(
        builder: (BuildContext context , state){
          return ConditionalBuilder(
            condition:hotel_list.isNotEmpty ,
                          ...
                          child: Container(
                              ...
                              child:  Padding(
                                ...
                                child: Column(
                                  children: [
                                    InkWell(
                                      onTap: ()=> UHomeCubit.get(context).GetSPProfileForClient(
                                            id: hotel_list[index].spid!)
                                      ,
                                      child: Text(
                                        hotel_list[index].serviceName!,
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Center(
                                                child: Text(
                                                  hotel_list[index].title!,
                                                  style: GoogleFonts.acme(textStyle: const TextStyle(
                                                    fontWeight: FontWeight.bold,fontSize: 17,color: YellowColor,
                                                  )),
                                                ),
                                              ),
                                              Row(
                                        ...
                                        Expanded(
                                          child: Center(
                                            child: Container(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () =>
                                                  UHomeCubit.get(context).UaddtoCart(
                                                      service: hotel_list[index].serviceName!,
                                                      amount: int.parse(countercontroller.text),
                                                      price: hotel_list[index].price!,
                                                      id: hotel_list[index].id!,
                                                     image: "assets/icons/shopping-cart-symbol-clipart-5.png",
                                                      category: hotel_list[index].category!),
                                                style: ElevatedButton.styleFrom(
                                                  fixedSize:const Size(350, 45),
                                                  shadowColor: BlueColor ,
                                                  elevation: 30,
        ...
        listener:  (context , state){
          if(state is UaddtocartSuccessState){
             print(UHomeCubit.get(context).addtocartmodel!.message);
          ...
          if(state is getSPCProfSuccessState)
            {
              Navigator.push(
                  ...
                  builder: (context)=>ServicesProviderAccount()));
                   spprofilemodel2 = UHomeCubit.get(context).spprofilemodel;
