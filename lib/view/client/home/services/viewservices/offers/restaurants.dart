...
class Restaurants_Cafes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      UHomeCubit()
        ..GetRestaurantAndCafeData(),
      child: BlocConsumer<UHomeCubit, UHomeStates>(
        builder: (BuildContext context, state) {
          return ConditionalBuilder(
            condition: cafe_list.isNotEmpty,
                                    ...
                                    InkWell(
                                      onTap: () =>
                                          UHomeCubit.get(context)
                                              ...
                                              id: cafe_list[index].spid!)
                                      ,
                                      child: Text(
                                        cafe_list[index].serviceName!,
                                            ...
                                            child: Container(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () =>
                                                    UHomeCubit.get(context)
                                                        .UaddtoCart(
                                                        service: hotel_list[index]
                                                            .serviceName!,
                                                        amount: int.parse(
                                                            countercontroller
                                                                .text),
                                                        price: hotel_list[index]
                                                            .price!,
                                                        id: hotel_list[index]
                                                            .id!,
                                                        image: hotel_list[index]
                                                            .image!,
                                                        category: hotel_list[index]
                                                            .category!),
                                                style: ElevatedButton.styleFrom(
                                                  fixedSize: const Size(
                                                      350, 45),
