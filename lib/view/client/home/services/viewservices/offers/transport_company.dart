...
class TransportCompany extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      UHomeCubit()
        ..GetTransportationCompanyData(),
      child: BlocConsumer<UHomeCubit, UHomeStates>(
        builder: (BuildContext context, state) {
          return ConditionalBuilder(
            condition: Transportation_list.isNotEmpty,
            builder: (BuildContext context) {
              return SingleChildScrollView(
                child: Column(
                  children:
                  List.generate(
                      Transportation_list.length,
                          (index) {
                        return Padding(
                                  ...
                                  children: [
                                    InkWell(
                                      onTap: () =>
                                          UHomeCubit.get(context)
                                              ...
                                              id: Transportation_list[index]
                                                  .spid!)
                                      ,
                                      child: Text(
                                        Transportation_list[index].serviceName!,
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          left: 30.0, right: 20),
                                      child: Text(
                                        Transportation_list[index].detail!,
                                            ...
                                            child: Container(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () =>
                                                    UHomeCubit.get(context)
                                                        .UaddtoCart(
                                                        service: Transportation_list[index]
                                                            .serviceName!,
                                                        amount: int.parse(
                                                            countercontroller
                                                                .text),
                                                        price: Transportation_list[index]
                                                            .price!,
                                                        id: Transportation_list[index]
                                                            .id!,
                                                        image: Transportation_list[index]
                                                            .image!,
                                                        category: Transportation_list[index]
                                                            .category!),
                                                style: ElevatedButton.styleFrom(
                                                  fixedSize: const Size(
                                                      350, 45),
