      ...
      child: BlocConsumer<UHomeCubit, UHomeStates>(
        builder: (BuildContext context, state) {
          return ConditionalBuilder(
            condition: Bazaar_list.isNotEmpty ,
                                    ...
                                    InkWell(
                                      onTap: () =>
                                          UHomeCubit.get(context)
                                              ...
                                              id: Bazaar_list[index].spid!)
                                      ,
                                      child: Text(
                                        Bazaar_list[index].serviceName!,
                                            ...
                                            child: Container(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () =>
                                                    UHomeCubit.get(context)
                                                        .UaddtoCart(
                                                        service: Bazaar_list[index]
                                                            .serviceName!,
                                                        amount: int.parse(
                                                            countercontroller
                                                                .text),
                                                        price: Bazaar_list[index]
                                                            .price!,
                                                        id: Bazaar_list[index]
                                                            .id!,
                                                        image: Bazaar_list[index]
                                                            .image!,
                                                        category: Bazaar_list[index]
                                                            .category!),
                                                style: ElevatedButton.styleFrom(
                                                  fixedSize: const Size(
                                                      350, 45),
