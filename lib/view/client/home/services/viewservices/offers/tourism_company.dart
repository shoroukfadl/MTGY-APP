...
class TourismCompany extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      UHomeCubit()
        ..GetTourismCompanyData(),
      child: BlocConsumer<UHomeCubit, UHomeStates>(
        builder: (BuildContext context, state) {
          return ConditionalBuilder(
            condition: tourismcomp_list.isNotEmpty ,
            builder: (BuildContext context) {
              return SingleChildScrollView(
                child: Column(
                  children:
                  List.generate(
                      tourismcomp_list.length,
                          (index) {
                        return Padding(
                                    ...
                                    InkWell(
                                      onTap: () =>
                                          UHomeCubit.get(context)
                                              ...
                                              id: tourismcomp_list[index].spid!)
                                      ,
                                      child: Text(
                                        tourismcomp_list[index].serviceName!,
                                            ...
                                            child: Container(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () =>
                                                    UHomeCubit.get(context)
                                                        .UaddtoCart(
                                                        service: tourismcomp_list[index]
                                                            .serviceName!,
                                                        amount: int.parse(
                                                            countercontroller
                                                                .text),
                                                        price: tourismcomp_list[index]
                                                            .price!,
                                                        id: tourismcomp_list[index]
                                                            .id!,
                                                        image: tourismcomp_list[index]
                                                            .image!,
                                                        category: tourismcomp_list[index]
                                                            .category!),
                                                style: ElevatedButton.styleFrom(
                                                  fixedSize: const Size(
                                                      350, 45),
